...
2. Click [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://www.heroku.com/deploy?template=https://github.com/Anilgurjar0008/Save-Restricted-Content-Bot-).
6. Enter required variables and click deploy ✅.
